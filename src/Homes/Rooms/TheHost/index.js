...
import HostProfile from "../Overview/HostProfile";
import hostPhoto from "../Overview/hostPhoto.png";
import NumberOfReviews from "./NumberOfReviews";
import Badge from "./Badge";
import downArrow from "../Overview/downArrow.svg";
...
const Merits = styled.div`
  margin-bottom: 48px;
`;

const Merit = styled.p`
  font-size: 18px;
  font-family: CircularAir-Light, sans-serif;
  color: #383838;
  margin: 0px 0 4px 0;
